...
angular.module('espnCreativeworksShowcaseApp')
  .controller('CollectionItemsModalCtrl',  ['$scope', '$modalInstance', 'Auth', 'Page', 'Collection', 'CollectionItem', 'media', 'type', function ($scope, $modalInstance, Auth, Page, Collection, CollecitonItem, media, type) {
